...
static void vStartTask( void *p_arg )
{
	...
	IO_Sensor_Init();
		...
		vTaskDelay(10*portTICK_MS);
		DMA_SendCommand(MOTOR_DIR_1,0x02,0x45,0x00,0x02,-4000);//发送速度	
...
//		switch(state)
//		{
//			case 0: DMA_SendCommand(3,0x02,0x45,0x00,0x02,test);//发送速度
//					vTaskDelay(5*portTICK_MS);break;
//			case 1: DMA_SendCommand(MOTOR_MARCH_2,0x02,0x45,0x00,0x02,test);//发送速度
//					vTaskDelay(5*portTICK_MS);break;
//			case 2: DMA_SendCommand(3,0x02,0x45,0x00,0x02,test);//发送速度
//					vTaskDelay(15*portTICK_MS);
//					DMA_SendCommand(4,0x02,0x45,0x00,0x02,test);//发送速度
//					vTaskDelay(15*portTICK_MS);
//					DMA_SendCommand(63,0x02,0x45,0x00,0x02,test);//发送速度
//					vTaskDelay(15*portTICK_MS);
//					DMA_SendCommand(1,0x02,0x45,0x00,0x02,test);//发送速度
//					vTaskDelay(15*portTICK_MS);
//			break;
//		}		
