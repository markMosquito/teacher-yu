...
{    
	...
	if((tmp[0]+tmp[1]+tmp[2]+tmp[3]) == tmp[4])
	{
		...
		if(remote_data[2] < 1900)
		{
			rotating_speed = (remote_data[2] - 1900)*40;
			rotating_flag = 1;
		}
		else if(remote_data[2] > 2150)
		{
			rotating_speed = (remote_data[2] - 2150)*40;
			rotating_flag = 1;
		}
		else
		{
		...
		if(rotating_speed > 100000)
		{
			rotating_speed = 100000;
		}
		else if(rotating_speed < -100000)
		{
			rotating_speed = -100000;
		}
