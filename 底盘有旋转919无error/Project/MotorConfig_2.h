...
/* EC30最大速度， 单位：cnt/s */
#define EC30_MAX_SPEED          ((int32_t)(16000*2000/60-1))
#define EC45_MAX_SPEED          ((int32_t)(10000*2000/60-1))
#define ST8N60P40V4E_MAX_SPEED  ((int32_t)(3000 *10000/60-1))
#define EC4270_MAX_SPEED        ((int32_t)(13000*10000/60-1))
...
/* 底盘电机减速比 */
#define CHASSIS_REDUCTION_RATIO (11.39)
/* 底盘编码器一圈计数值 */
#define CHASSIS_ENCODER_CIRCLE_CNT      (2000)
/* 底盘车轮的最大速度(cnt/s) */
#define CHASSIS_MAX_SPEED               EC45_MAX_SPEED
    
/* 滑轨 Motor Can ID & Dir----------------------------------------------------*/
#define MOTOR_ID_SLIDEWAY_X                 (1)
#define MOTOR_DIR_SLIDEWAY_X                (-1)
#define MOTOR_REDUCTION_RATIO_SLIDEWAY_X    (19.0f)
...
#define MOTOR_REDUCTION_RATIO_SLIDEWAY_Y    (19.0f)
...
#define MOTOR_REDUCTION_RATIO_HIT_MAIN      (28.5f)
...
#define MOTOR_MAXSPEED_HIT_MAIN             EC30_MAX_SPEED

#define MOTOR_ID_HIT_SERVE                  (4)
#define MOTOR_DIR_HIT_SERVE                 (1)
#define MOTOR_REDUCTION_RATIO_HIT_SERVE     (28.5f)
...
#define MOTOR_MAXSPEED_HIT_SERVE            EC30_MAX_SPEED

/* 加速度 */                                //减速后转速rps^2 -->> cnt/s^2
#define CHASSIS_ACC_MAX                     (750000)//((int32_t)(33*CHASSIS_REDUCTION_RATIO*CHASSIS_ENCODER_CIRCLE_CNT))
#define SLIDEWAY_X_ACC_MAX                  (100000000)//((int32_t)(100000000))	//1m/s2 190000 60000 * 190
#define SLIDEWAY_Y_ACC_MAX                  (35000 * 190)//((int32_t)(35000 * 190))	//1m/s2 190000
