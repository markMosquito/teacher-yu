...
void USART1_Config(void)
{
	...
	/* config USART1 clock */
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART1 | RCC_APB2Periph_GPIOA, ENABLE);//初始化USART1和GPIOA的时钟
	
	/* USART1 GPIO config */	//GPIO初始化
	...
	/* USART1 mode config */	//串口的模式，波特率初始化
